...
function cndContent() {
    document.getElementById('contentDesc').innerHTML = "I'm Canadian-born but I only visit the country during vacations since a lot of my family lives there. I enjoy snowy weather, eating poutine, and sight-seeing around the unique terrain.";
}
function amrContent() {
