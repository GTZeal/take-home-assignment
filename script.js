...
function cndContent() {
    document.getElementById('contentDesc').innerHTML = "I'm Canadian-born but I only visit the country during vacations since a lot of my family lives there. I love visiting Canada for vacation as a good chunk of my family lives there. There's nothing better than eating some piping hot poutine in snowy weather";
}
function amrContent() {
