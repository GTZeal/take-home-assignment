...
function pkContent() {
    document.getElementById('contentDesc').innerHTML = "Both my Parents are from Lahore, Pakistan. Although I've never lived in Pakistan it still feels very familiar. It's quite important for me to stay connected with my roots.";
}
function cndContent() {
    document.getElementById('contentDesc').innerHTML = "I'm Canadian-born but haven't experienced much of that land. I love visiting Canada for vacation as a good chunk of my family lives there. There's nothing better than eating some piping hot poutine in snowy weather";
}
function amrContent() {
